...
Next:
   ...
   LOAD   Pointer
   ADDI   -36         ;*****If the robot is stopping too soon and not sending 12 lines with IndicateDest, then try increasing this value to -38 or so. This might require adding a couple "DW 0" to the end of the table.
   SUB    InitPointer
   JZERO  Die
   JPOS   Die
   JUMP   Loop
